...
<table class="table">
    <thead>
        <tr>
            ...
            <th>Teléfono</th>
            <th>Rol</th>
            <?php if (tienePrivilegios($datos['usuarioSesion']->user_rol, [1, 20])) : ?>
                <th>Acciones</th>
            <?php endif ?>
        </tr>
    </thead>
    <tbody>
        <?php foreach ($datos['usuarios'] as $uruario) : ?>
            <tr>
                <td><?php echo $uruario->user_username ?></td>
                <td><?php echo $uruario->user_nombre ?></td>
                <td><?php echo $uruario->user_email ?></td>
                <td><?php echo $uruario->user_userpass ?></td>
                <td><?php echo $uruario->user_rol ?></td>
        ...
        <?php endforeach ?>
        <?php $this->vista('usuarios/agregar_editar.php', $this->datos);
        ?>
    </tbody>
</table>
