        ...
        public function agregar(){
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $usuarioNuevo = [
                    ...
                    'user_apell1' => trim($_POST['user_apell1']),
                    'user_apell2' => trim($_POST['user_apell2']),
                    'user_nif' => trim($_POST['user_nif']),
                    'user_rol' => trim($_POST['user_rol']),
                    'user_fnac' => trim($_POST['user_fnac']),
                ];
